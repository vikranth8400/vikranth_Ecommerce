...
Stripe Payment Gateway for WooCommerce integrates with Buy Now Pay Later (BNPL) payment gateways such as Affirm, Klarna and Afterpay. You can now offer your consumers the flexibility to make purchases instantly and pay for them later in installments. Check out this video tutorial to set up BNPL payments in your store:
