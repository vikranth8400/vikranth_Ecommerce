              ...
              <div <?php if($i == 1){echo 'class="carousel-item active"';} else{ echo 'class="carousel-item"';}?>>
                ...
                <div class="carousel-caption">
                  <div class="slider-inner-box">
                    ...
                    <?php }?>
                    <?php if( get_theme_mod('vw_sports_slider_button_text','Read More') != ''|| get_theme_mod('vw_sports_slider_button_link')!= ''){ ?>
                      <div class="more-btn my-3 my-lg-5 my-md-4 wow rollIn delay-1000" data-wow-duration="3s">
                        <a class="p-3" href="<?php echo esc_url(get_theme_mod('vw_sports_slider_button_link','')); ?>"><?php echo esc_html(get_theme_mod('vw_sports_slider_button_text',__('Read More','vw-sports')));?><span class="screen-reader-text"><?php echo esc_html(get_theme_mod('vw_sports_button_text',__('Read More','vw-sports')));?></span></a>
                      </div>
                    <?php } ?>
                  </div>
                </div>
