...
<?php if ( is_home() && current_user_can( 'publish_posts' ) ) : ?>
	...
	<div class="error-btn">
		<a href="<?php echo esc_url(home_url() ); ?>"><?php esc_html_e( 'Back to Home Page', 'vw-sports' ); ?><span class="screen-reader-text"><?php esc_html_e( 'Back to Home Page','vw-sports' );?></span></a>
	</div>
<?php endif; ?>