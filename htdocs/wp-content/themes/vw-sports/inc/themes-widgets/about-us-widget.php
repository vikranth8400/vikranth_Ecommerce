...
class VW_Sports_About_Widget extends WP_Widget {
	function __construct() {
		parent::__construct(
			'VW_Sports_About_Widget',
			__('VW About us', 'vw-sports'),
			array( 'description' => __( 'Widget for about us section in sidebar', 'vw-sports' ), ) 
		);
	}
	...
	?>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('author')); ?>"><?php esc_html_e('Author Name:','vw-sports'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('designation')); ?>"><?php esc_html_e('Designation:','vw-sports'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('description')); ?>"><?php esc_html_e('Description:','vw-sports'); ?></label>
    	...
    	<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_text')); ?>"><?php esc_html_e('Button Text:','vw-sports'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_url')); ?>"><?php esc_html_e('Button Url:','vw-sports'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'upload_image' )); ?>"><?php esc_html_e( 'Image Url:','vw-sports'); ?></label>
		<?php
			if ( $upload_image != '' ) :
...
function vw_sports_about_custom_load_widget() {
	register_widget( 'VW_Sports_About_Widget' );
}
add_action( 'widgets_init', 'vw_sports_about_custom_load_widget' );