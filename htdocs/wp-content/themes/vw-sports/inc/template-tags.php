 ...
 * Posts pagination.
 */
if ( ! function_exists( 'vw_sports_blog_posts_pagination' ) ) {
	function vw_sports_blog_posts_pagination() {
		$pagination_type = get_theme_mod( 'vw_sports_blog_pagination_type', 'blog-page-numbers' );
