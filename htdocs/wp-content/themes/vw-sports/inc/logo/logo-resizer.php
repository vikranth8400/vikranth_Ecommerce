...
function vw_sports_logo_customize_register( $wp_customize ) {
	...
	$wp_customize->add_setting('vw_sports_logo_width',array(
		'default'=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
		));
	$wp_customize->add_control('vw_sports_logo_width',array(
		'label'	=> __('Logo Width','vw-sports'),
	...
	$wp_customize->add_setting('vw_sports_logo_height',array(
		'default'=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('vw_sports_logo_height',array(
		'label'	=> __('Logo Height','vw-sports'),
		'description'	=> __('Enter a value in pixels. Example:20px','vw-sports'),
		'input_attrs' => array(
    	'placeholder' => __( '10px', 'vw-sports' ),),
		'section'=> 'title_tagline',
	...
	$wp_customize->add_setting('vw_sports_site_title_color', array(
		'default'           => '#151821',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'vw_sports_site_title_color', array(
		'label'    => __('Site Title Color', 'vw-sports'),
		'section'  => 'title_tagline',
		'active_callback' => 'vw_sports_logo_title_hide_show'
	)));
	...
	$wp_customize->add_setting('vw_sports_site_tagline_color', array(
		'default'           => '#151821',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'vw_sports_site_tagline_color', array(
		'label'    => __('Site Tagline Color', 'vw-sports'),
		'section'  => 'title_tagline',
		'active_callback' => 'vw_sports_tagline_hide_show'
	)));
}
