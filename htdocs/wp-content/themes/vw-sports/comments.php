...
<div id="comments" class="comments-area">
	<?php if ( have_comments() ) : ?>
		<h3 class="comments-title">
			<?php
				$vw_sports_comments_number = get_comments_number();
				if ( 1 === $vw_sports_comments_number ) {
					...
					printf(
					   	esc_html(
					     	...
					     	_nx( 
					          	...
					          	$vw_sports_comments_number,
					          	'comments title',
					          	'vw-sports'
					       	)
					   	),
					   	esc_html (number_format_i18n( $vw_sports_comments_number ) ),
